...
About Testing and Debugging,Dubhe Using Native aptos Move Way to slove this process.

https://docs.aptos.io/guides/developer/first-app/build-test#testing-a-package
https://docs.aptos.io/guides/developer/first-app/debug
